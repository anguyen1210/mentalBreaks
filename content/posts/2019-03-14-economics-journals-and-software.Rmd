...
> **Stata vs. the rest--examining software preferences in journal submissions to the AEA.**
...
Because the [AEA](https://www.aeaweb.org/journals/) requires all authors to upload their data and replication code to go along with journal submissions, there's a nice little repository of articles, data and code that goes back a little over a decade. Kranz has built a Shiny [app that allows you to search the AEA data archives](http://econ.mathematik.uni-ulm.de:3200/ejd/) to see what data is available. Definitely have a look, it's well done.
