...
asy_ulv <- single_varirf_grouped %>% 
  ggplot(aes(x=period, y=irf_asy_ulv)) +
  geom_hline(yintercept = 0, color="red") +
  geom_ribbon(aes(ymin=lower_asy_ulv, ymax=upper_asy_ulv), fill="grey", alpha=.2) +
  geom_line() +
  geom_line(data= single_varirf_grouped, aes(y=lower_asy_ulv), linetype="dashed", color="grey50") +
  geom_line(data= single_varirf_grouped, aes(y=upper_asy_ulv), linetype="dashed", color="grey50") +
  theme_light() +
