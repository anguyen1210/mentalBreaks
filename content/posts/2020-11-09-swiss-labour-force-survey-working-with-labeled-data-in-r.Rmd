...
(*Note*: If for some reason you only want to import the data and apply only one or the other of the variable or value files, that's also fine, but to do both at the same time, the order matters.) 
```{r eval=TRUE, echo=FALSE}
