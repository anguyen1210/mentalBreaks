...
As already mentioned, I wanted to see how much the results were affected by the sample restrictions, so for this analysis, I created three different sub-samples of the Swiss census data: (1) prime-working age males only (Ages 15-54), (2) all working age males (Ages 15+), and all working age male and females (Ages 15+). In keeping with the literature, I use educational attainment level to proxy for worker skill-level, with the idea that workers with similar skill-levels in the same regional markets would compete for jobs.  
